...
export function getAntigravityRequestModelId(modelId, effort) {
...
export const ANTIGRAVITY_MODEL_ENUM = {
...
export function getThinkingConfig(modelId, effort) {
    ...
    if (modelId === "gemini-3.5-flash") {
        ...
        const thinkingBudget = effort === "high" || effort === "xhigh" ? 10_000 : effort === "medium" ? 4_000 : 1_000;
