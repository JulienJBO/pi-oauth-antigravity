...
import type { OAuthCredentials, SimpleStreamOptions, TextContent, ThinkingContent, ToolCall } from "@earendil-works/pi-ai";
import type { AntigravityRequestType, AntigravityUserAgent, GeminiRole, GeminiToolCallingMode, ThinkingEffort, ToolChoice } from "./enums.js";
...
export declare const ANTIGRAVITY_API: "antigravity-api";
...
export type GeminiPart = GeminiTextPart | GeminiInlineDataPart | GeminiThoughtPart | GeminiFunctionCallPart | GeminiFunctionResponsePart;
